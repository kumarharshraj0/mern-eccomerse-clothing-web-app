        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-2xl shadow-slate-200/50 overflow-hidden relative group">
          ...
          <div className="p-10 lg:p-12">
            <div className="space-y-2 mb-10 text-center">
              <h1 className="text-4xl font-black tracking-tighter text-slate-900">WELCOME <span className="text-primary italic font-serif">Back</span></h1>
              <p className="text-slate-500 font-medium">Enter your credentials to access the collection</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between px-1">
                    <Label htmlFor="password" className="text-xs font-black uppercase tracking-widest text-slate-400">Security Key</Label>
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest text-slate-300"><span className="bg-white px-4">Direct Connect</span></div>
                </div>
            ...
            <p className="mt-10 text-center text-sm font-medium text-slate-500">
              New to the circle?{" "}
              <Link to="/signup" className="text-primary font-black hover:underline underline-offset-4 tracking-tight">Create Exclusive Account</Link>
            </p>
          </div>
        </div>
      </motion.div>
