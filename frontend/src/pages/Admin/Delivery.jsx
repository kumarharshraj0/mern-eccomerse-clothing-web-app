      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-1">
          <div className="flex items-center gap-3 text-primary mb-2">
            <Truck size={24} />
            <span className="text-[10px] font-semibold uppercase tracking-[0.3em]">Module 04: Logistics</span>
          </div>
          <h1 className="text-4xl font-semibold tracking-tighter text-slate-900 uppercase">Logistics Command</h1>
          <p className="text-slate-500 font-medium font-serif text-lg">Optimizing fulfillment personnel & deployment</p>
        </div>
          ...
          {deliveryBoys.map((db, i) => (
            ...
            >
              ...
              <div className="space-y-1 mb-6 w-full min-w-0">
                <h3 className="text-lg font-semibold text-slate-900 uppercase tracking-tight truncate">{db.name}</h3>
                <div className="flex items-center justify-center gap-1.5 text-slate-400">
                  <Mail size={12} />
                  <p className="text-[10px] font-semibold uppercase tracking-widest truncate">{db.email}</p>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-2 w-full mb-8">
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-50">
                  <p className="text-[8px] font-semibold text-slate-400 uppercase tracking-[0.2em] mb-1">Status</p>
                  <div className="flex items-center justify-center gap-1.5 text-emerald-600">
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                    <span className="text-[9px] font-semibold uppercase tracking-widest">Active</span>
                  </div>
                </div>
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-50">
                  <p className="text-[8px] font-semibold text-slate-400 uppercase tracking-[0.2em] mb-1">Impact</p>
                  <div className="flex items-center justify-center gap-1.5 text-indigo-600">
                    <Zap size={10} />
                    <span className="text-[9px] font-semibold uppercase tracking-widest">Elite</span>
                  </div>
                </div>
              </div>

              <Button variant="outline" className="w-full h-12 rounded-xl border-slate-100 font-semibold uppercase tracking-widest text-[9px] hover:bg-slate-50 hover:text-primary transition-all gap-2">
        ...
        <SheetContent className="max-w-md w-full border-none shadow-2xl p-0">
          <div className="h-full flex flex-col bg-white">
            <SheetHeader className="p-10 border-b border-slate-50">
              <div className="space-y-1">
                <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-primary">Credentialing Module</span>
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-10 space-y-8">
              <div className="space-y-6">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h4 className="text-xs font-semibold uppercase tracking-widest text-slate-900">Identity Profile</h4>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-14 rounded-xl border-slate-100 bg-slate-50 font-semibold focus:bg-white transition-all"
                    value={form.name}
                ...
                <div className="space-y-2">
                  <Label className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 ml-1">Communication Channel (Email)</Label>
                  <Input
                    type="email"
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h4 className="text-xs font-semibold uppercase tracking-widest text-slate-900">Security Access</h4>
                </div>

                <div className="space-y-2">
                  <Label className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 ml-1">Access Protocol (Password)</Label>
                  <Input
                    type="password"
                    placeholder="••••••••"
                    className="h-14 rounded-xl border-slate-100 bg-slate-50 font-semibold focus:bg-white transition-all"
